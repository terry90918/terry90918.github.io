...
export async function up({ db }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "articles" ADD CONSTRAINT "articles_feature_image_id_media_id_fk" FOREIGN KEY ("feature_image_id") REFERENCES "public"."media"("id") ON DELETE set null ON UPDATE no action;
  ...
  CREATE INDEX "articles_feature_image_idx" ON "articles" USING btree ("feature_image_id");
